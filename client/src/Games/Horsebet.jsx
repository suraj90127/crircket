...
export default function Horsebet() {
  ...
  return (
    <div className="mx-auto text-[13px]">
      <div className="flex justify-between items-center rounded-t-md">
        <span className="font-bold bg-blue p-2 px-4 rounded-tr-3xl text-white flex items-center gap-1">To be played <IoIosInformationCircleOutline className="size-5" /></span>
      ...
      {bettingData.map(({ team, odds, amounts }, index) => (
        <div key={index}>
          ...
          >
            <div className="col-span-3 md:col-span-1 p-1 font-bold text-left pl-4"><span className="font-[500]">{index}. </span>{team}</div>
            {odds.map((odd, i) => (
          ...
          <div
            className="flex gap-2 text-center border-b border-gray-300 cursor-pointer hover:bg-gray-200"
            onClick={() => setSelectedRun(index)}
          >
            <div className="col-span-1 rounded text-left px-1 text-[10px] bg-[#78aea294]"> <span className="font-[500]">Jackey:</span> {team}</div>
            <div className="col-span-1 rounded text-left px-1 text-[10px] bg-[#78aea294]"> <span className="font-[500]">Trainer:</span> {team}</div>
            <div className="col-span-1 rounded text-left px-1 text-[10px] bg-[#78aea294]"> <span className="font-[500]">Age:</span> {team}</div>
            <div className="col-span-1 rounded text-left px-1 text-[10px] bg-[#78aea294]"> <span className="font-[500]">Weight:</span> {team}</div>
          </div>
