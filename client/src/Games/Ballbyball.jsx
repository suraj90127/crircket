  ...
  return (
    <div className="mx-auto text-[13px]">
      <div className="flex justify-between items-center rounded-t-md">
        <span className="font-bold bg-blue p-2 px-4 rounded-tr-3xl text-white">
          Match Odds
        </span>
      ...
      <div className="grid grid-cols-7 text-center border-b border-gray-300">
        ...
        <div className="bg-[#bed5d8] text-[#2789ce] p-1 rounded-lg col-span-2 hidden md:block">
          Min/Max 100-100000
        </div>
      </div>
      {bettingData.map(({ team, odds, amounts }, index) => (
        <div key={index}>
          ...
          >
            <div className="col-span-3 md:col-span-1 p-1 font-bold text-left pl-4">
              {team}
            </div>
            {odds.map((odd, i) => (
              <div
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <div className="flex items-center w-full justify-between border rounded-sm overflow-hidden col-span-2 md:col-span-1">
                  <button
                    ...
                    onClick={() =>
                      setBetOdds((prev) => (prev > 1 ? prev - 0.1 : prev))
                    }
                  >
                    -
                  </button>
