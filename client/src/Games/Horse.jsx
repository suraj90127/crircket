      ...
      <div className="max-h-[40vh] md:max-h-[80vh] mx-auto overflow-auto">
        ...
        {activeTab === "ALL" && (
          ...
          <div className="bg-white">
            {bettingData.map((bet) => (
              <div className="grid grid-cols-12 gap-1 border-b border-gray-400 py-0.5 items-center text-[12px]" key={bet.id}>
                {/* <Link to='/greyhound-bet' key={bet.id} className="grid grid-cols-12 gap-1 border-b border-gray-400 py-0.5 items-center text-[12px]"> */}
                ...
                <div className="col-span-2 md:col-span-1 text-center flex justify-end">
