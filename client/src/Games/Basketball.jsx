  ...
  return (
    <div>
      ...
      <div className="max-h-[40vh] md:max-h-[80vh] mx-auto">
        ...
        <div className="hidden md:grid grid-cols-12 bg-[#dddcd6] text-black font-bold  text-center text-[13px]">
        ...
        <div className="bg-white">
          {bettingData.map((bet) => (
            <Link to='/' key={bet.id} className="grid grid-cols-12 gap-1 border-b border-gray-400 py-0.5 items-center text-[12px]">
              <div className="col-span-10 md:col-span-5 pl-2 flex justify-between items-center">
                <div className="flex items-center gap-0.5">
                  <div className="text-[#2789ce] font-semibold">{bet.match}
