...
import { getPendingBetAmo, fetchTannisBatingData, getBetPerents, masterBookReducer, masterBookReducerDownline } from "../redux/reducer/marketAnalyzeReducer";
...
export default function Tennisbet() {
  ...
  const { loading, pendingBet, battingData, betsData, betPerantsData, masterData, masterDataDownline } = useSelector((state) => state.market);
