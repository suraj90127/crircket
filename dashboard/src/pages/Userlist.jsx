...
export default function AgentLIst() {
  ...
  // console.log(gameLockData, "gamelockData");
  ...
  const handleWithdwalDeposite = async (e) => {
    ...
    try {
      ...
      dispatch(getAllOnlyUserAndDownline({ page: currentPage, limit: entries, searchQuery }));
      dispatch(getAdmin());
  ...
  const handleUpdateExploserLimit = async (e) => {
    e.preventDefault();
    try {
      const data = await dispatch(updateExploserLimit({ formData, userId: currentUser._id })).unwrap();
      toast.success(data.message);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100 p-1 md:p-4">
                        ...
                        <div className="flex items-center gap-2">
                          {isFetchingAllUsers == true ? (
                            <>
                              ...
                              <div
                                onClick={() => navigate(`/online-user/${user._id}`, { state: { mystate: "PL" } })}
                                className="text-lg bg-gray-200 border border-gray-500 rounded-sm p-0.5 text-gray-600 cursor-pointer">
                                <span>
                                  <PiArrowsDownUpBold />
                                </span>
                              ...
                              <div
                                onClick={() => navigate(`/online-user/${user._id}`, { state: { mystate: "BH" } })}
                                className="text-lg bg-gray-200 border border-gray-500 rounded-sm p-0.5 text-gray-600 cursor-pointer">
                                <span>
                                  <LuListCheck />
                                </span>
        ...
        {isEdit && (
          <div className="fixed inset-0 flex items-center z-10 justify-center bg-[#00000074] p-4"
          >
            <motion.div
              ...
              className="bg-white w-full max-w-[500px] rounded-lg shadow-lg overflow-y-auto max-h-[90vh]">
              {/* Header */}
              ...
              <form onSubmit={handleSubmit} className="p-4 space-y-2">
                <div className="grid grid-cols-3 gap-2 items-center px-4 py-1">
                  ...
                  <input
                    type="text"
                    className="border border-gray-300 col-span-2 px-2 py-0.5 text-xs md:text-sm md:py-1 rounded-md w-full"
                    onChange={(e) =>
        ...
        {creditPopup && (
          <motion.div
            ...
            transition={{ duration: 0.4 }}
            className="fixed inset-0 flex items-center justify-center bg-[#00000074]"
          >
            <div className="bg-white w-70 md:w-100 rounded-lg shadow-lg">
              ...
              <div className="p-4 space-y-2">
                <form onSubmit={handleUpdateCredit} className="p-4 space-y-2">
