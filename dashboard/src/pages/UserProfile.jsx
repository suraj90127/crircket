        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex-1">
                          ...
                          {PLdata?.length > 0 ? (
                            PLdata.map((item, index) => (
                              <tr key={index} className="hover:bg-gray-100 text-center text-sm font-semibold">
                                <td className="border border-gray-300 p-2 text-[#2789ce] cursor-pointer" onClick={() => navigate(`/userplyevent/${item.name}/${id}`)}>
                                  {item.name}
                                </td>
                                <td className={`border border-gray-300 p-2 ${(item.myProfit).toFixed(2) > 0 ? "text-green-500" : "text-red-500"}`}>
            ...
            {activeTab === "BH" && (
              <div className="p-2">
                {/* Filter Section */}
                <div className=" rounded-lg text-[13px] bg-[#e0e6e6] p-4 mb-4">
                  <div className="grid grid-cols-2 md:grid-cols-5 items-end gap-2">
                    <div className="w-full ">
                      <label className="block mb-1">Choose Type</label>
                      <select
                        value={selectedVoid}
                        onChange={(e) => setSelectedVoid(e.target.value)}
                        className="border border-gray-300  p-2 bg-white col-span-1 w-full text-sm"
                      >
                    ...
                    <div className="w-full bg-[#e0e6e6] ">
                      <label className="block mb-1">Choose Sports</label>
                      <select
                        value={selectedGame}
                        onChange={(e) => setSelectedGame(e.target.value)}
                        className="border border-gray-300 p-2 bg-[#ffffff] col-span-1 w-full text-sm"
                      >
                ...
                {!loading && (
                  ...
                  <div className="border border-gray-300 bg-white  text-[15px]">
                    <div className="bg-dark text-white py-1 px-3">
                      <h2 className="font-bold text-base">Betting History</h2>
                    </div>
                          ...
                          <tbody>
                            {betHistory?.length > 0 ? (
                              betHistory.map((item, index) => (
                                <tr key={index} className="hover:bg-gray-100 text-center text-[13px] font-[500] ">
                                  <td className="border border-gray-300 p-2">
                                    {item.userName}
                                  </td>
                                  <td className={`border border-gray-300 p-2 `}>
